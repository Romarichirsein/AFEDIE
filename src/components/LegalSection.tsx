            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              {[
                ...
                <div key={i} style={{ display: "flex", borderBottom: "1px solid #f8f8f8", paddingBottom: "1.2rem", alignItems: "flex-start" }}>
                  <span style={{ fontSize: "0.7rem", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: "#999", flex: "0 0 100px", maxWidth: "100px", marginTop: "0.2rem" }}>{item.k}</span>
